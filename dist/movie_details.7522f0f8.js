...
},{}],"js/movie_details.js":[function(require,module,exports) {
const axios = require('axios');

const moment = require('moment'); // require('dotenv').config();
...
function getActors(movie) {
  ...
  credits.splice(5, credits.length); // <img src="${url}" alt="${actor.name}" />

  const html = credits.map(actor => {
...
function getReleaseDateInfo(movie) {
  ...
  const release_dates = results.filter(iso => iso.iso_3166_1 === 'US').map(item => item.release_dates);
  return release_dates[0];
}

function getReleaseInfo(dateInfo) {
  const html = dateInfo.map(item => {
    const date = moment(item.release_date, 'YYYY/MM/DD').format('LL');
    const type = item.type === 1 ? 'Premiere' : item.type === 2 ? 'Theatrical (limited)' : item.type === 3 ? 'Theatrical' : item.type === 4 ? 'Digital' : item.type === 5 ? 'Physical' : 'TV';
...
},{"axios":"../node_modules/axios/index.js","moment":"../node_modules/moment/moment.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/movie_details.js"], null)
//# sourceMappingURL=/movie_details.7522f0f8.js.map