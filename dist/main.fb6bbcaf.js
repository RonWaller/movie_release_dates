...
function init(year) {
  getMovies(year).then(movies => buildContent(movies)).catch(err => console.log(err));
}
...
document.addEventListener('DOMContentLoaded', init(year)); // const moreInfo = document.getElementById('moreInfo');
